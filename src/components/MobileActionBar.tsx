 ...
 * Ta kontakt and Be om tilbud. "Få prisestimat" lives in the header,
 * so the bar carries the two contact routes. Hidden on `lg` and above
 * (desktop nav has its own "Be om tilbud" CTA), and on routes where it
 * would fight with the primary in-page CTA (`/kontakt`, `/prisestimat`).
 */
